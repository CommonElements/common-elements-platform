...
export function EditProposalForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      setError(result.error?.message || 'Failed to update proposal')
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex gap-4">
        ...
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
