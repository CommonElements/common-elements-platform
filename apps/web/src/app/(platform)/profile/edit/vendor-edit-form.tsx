...
import type { VendorProfile } from '@repo/database'
...
export function VendorEditForm({ userId, profile }: VendorEditFormProps) {
  ...
  const [selectedAreas, setSelectedAreas] = useState<string[]>(profile.service_areas)
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Server action
    const response = await updateVendorProfile(userId, result.data)
    setIsLoading(false)
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            name="licenseInfo"
            type="text"
            defaultValue={profile.license_info || ''}
            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
        ...
        <div>
          ...
          <input
            ...
            name="insuranceInfo"
            type="text"
            defaultValue={profile.insurance_info || ''}
            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
