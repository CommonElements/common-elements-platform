...
import { updateCommunityMemberProfile } from './actions'
import type { CommunityProfile } from '@repo/database'

type CommunityMemberEditFormProps = {
  userId: string
...
export function CommunityMemberEditForm({ userId, profile }: CommunityMemberEditFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Server action
    const response = await updateCommunityMemberProfile(userId, result.data)
    setIsLoading(false)
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            type="text"
            required
            defaultValue={profile.property_location}
            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
        ...
        <div className="flex items-start">
          <div className="flex h-5 items-center">
            <input
              ...
              type="checkbox"
              defaultChecked={profile.hide_property_name}
